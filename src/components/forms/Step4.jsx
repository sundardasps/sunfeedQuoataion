...
import productInformationSchema from "../../yup/step4";
...
function Step4() {
  ...
  const { errors, handleBlur, handleChange, values, touched, handleSubmit } =
    useFormik({
      initialValues: data.invoice.product_information,
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <InputField
          value={values.ground_opening_size}
          name="ground_opening_size"
          onBlur={handleBlur}
          onChange={(e) => numberValidation(e, handleChange)}
        />
      ...
      <div>
        ...
        <InputField
          value={values.driver_transformer}
      ...
      <div>
        ...
        <InputField
          value={values.waterproof_coating}
          name="waterproof_coating"
          onBlur={handleBlur}
          onChange={handleChange}
        />
      ...
      <div>
        <div className="mb-2 block">
          <InputLabel label="Technical Studies" />
        </div>
        <InputField
          value={values.technical_studies}
          name="technical_studies"
          onBlur={handleBlur}
          onChange={handleChange}
        />
      ...
      <div>
        <div className="mb-2 block">
          <InputLabel label="Construction Permit Site Fees " />
        </div>
        <InputField
          value={values.construction_permit_fees}
          name="construction_permit_fees"
          onBlur={handleBlur}
          onChange={handleChange}
        />
        {errors.construction_permit_fees && touched.construction_permit_fees && (
          <ErrorMssgField errorMessage={errors.construction_permit_fees} />
        )}
      </div>
      <div>
        <div className="mb-2 block">
